...
extern Void ti_sysbios_family_msp430_Hwi47_p2(Void);

#if defined(__ICC430__)
#pragma inline=never
#endif
extern Void port1_isr(UArg);
#if defined(__ICC430__)
#pragma vector = 47 * 2
#else
#pragma vector = 47;
...
__interrupt Void ti_sysbios_family_msp430_Hwi47(Void)
{
    ...
    /* switch stacks and then run the phase 2 function */
    ti_sysbios_family_xxx_Hwi_switchAndRunFunc(&ti_sysbios_family_msp430_Hwi47_p2);
...
Void ti_sysbios_family_msp430_Hwi47_p2(Void)
{
    ti_sysbios_BIOS_ThreadType prevThreadType;
    UInt swiKey;
...
extern Void ti_sysbios_family_msp430_Hwi55_p2(Void);
