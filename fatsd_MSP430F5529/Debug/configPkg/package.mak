...
.dlls,e430X .dlls: fatsd_msp430.pe430X

-include package/cfg/fatsd_msp430_pe430X.mak
-include package/cfg/fatsd_msp430_pe430X.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/fatsd_msp430_pe430X.dep
endif
fatsd_msp430.pe430X: package/cfg/fatsd_msp430_pe430X.xdl
	@


ifeq (,$(wildcard .libraries,e430X))
fatsd_msp430.pe430X package/cfg/fatsd_msp430_pe430X.c: .libraries,e430X
endif

package/cfg/fatsd_msp430_pe430X.c package/cfg/fatsd_msp430_pe430X.h package/cfg/fatsd_msp430_pe430X.xdl: override _PROG_NAME := fatsd_msp430.xe430X
package/cfg/fatsd_msp430_pe430X.c: package/cfg/fatsd_msp430_pe430X.cfg
package/cfg/fatsd_msp430_pe430X.xdc.inc: package/cfg/fatsd_msp430_pe430X.xdl
package/cfg/fatsd_msp430_pe430X.xdl package/cfg/fatsd_msp430_pe430X.c: .interfaces

clean:: clean,e430X
	-$(RM) package/cfg/fatsd_msp430_pe430X.cfg
	-$(RM) package/cfg/fatsd_msp430_pe430X.dep
	-$(RM) package/cfg/fatsd_msp430_pe430X.c
	-$(RM) package/cfg/fatsd_msp430_pe430X.xdc.inc

clean,e430X::
	-$(RM) fatsd_msp430.pe430X
.executables,e430X .executables: fatsd_msp430.xe430X

fatsd_msp430.xe430X: |fatsd_msp430.pe430X

-include package/cfg/fatsd_msp430.xe430X.mak
fatsd_msp430.xe430X: package/cfg/fatsd_msp430_pe430X.oe430X 
	$(RM) $@
	@$(MSG) lnke430X $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/lnk430 -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/fatsd_msp430_pe430X.oe430X   package/cfg/fatsd_msp430_pe430X.xdl  -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.msp430.elf.MSP430X.rootDir)/lib/libc.a
	
fatsd_msp430.xe430X: export C_DIR=
fatsd_msp430.xe430X: PATH:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/:$(PATH)

fatsd_msp430.test test,e430X test: fatsd_msp430.xe430X.test

fatsd_msp430.xe430X.test:: fatsd_msp430.xe430X
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 fatsd_msp430.xe430X.test
else
	@$(MSG) running $<  ...
	$(call EXEC.fatsd_msp430.xe430X, ) 
endif

clean,e430X::
	-$(RM) $(wildcard .tmp,fatsd_msp430.xe430X,*)


clean:: clean,e430X

clean,e430X::
	-$(RM) fatsd_msp430.xe430X
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
fatsd_msp430_pe430X.oe430X,copy : package/cfg/fatsd_msp430_pe430X.oe430X
fatsd_msp430_pe430X.se430X,copy : package/cfg/fatsd_msp430_pe430X.se430X
